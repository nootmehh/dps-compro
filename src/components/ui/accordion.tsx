    ...
    <div className={`w-full flex flex-col justify-start items-start gap-3.5 sm:gap-4 ${className}`}>
      {items.map((item) => {
        ...
        return (
          ...
          >
            {/* Left Segment: Question Pill & Smooth Expandable Answer */}
            <div
            ...
            >
              ...
              <div className="h-12 sm:h-14 px-5 sm:px-6 flex items-center justify-between">
                <span
              ...
              >
                <div className="overflow-hidden">
                  <div className="px-5 sm:px-6 pb-5 pt-0 flex flex-col gap-3">
            ...
            <div
              className={`size-12 sm:size-14 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 ${
                isExpanded
